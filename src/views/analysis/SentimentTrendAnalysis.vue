<template>
  <div class="sentiment-trend-wrapper">
    <div class="sentiment-trend-container">
      <h2 class="sentiment-trend-title">情感趋势分析</h2>
          ...
          <div class="stats-grid">
            ...
            <div class="stat-card positive">
              <div class="stat-info">
                ...
                <h3 class="stat-value">{{ trendData.positive_count }}</h3>
                <div class="stat-ratio">{{ trendData.positive_ratio }}%</div>
              </div>
              <div class="stat-icon">
            ...
            <div class="stat-card negative">
              <div class="stat-info">
                ...
                <h3 class="stat-value">{{ trendData.negative_count }}</h3>
                <div class="stat-ratio">{{ trendData.negative_ratio }}%</div>
              </div>
              <div class="stat-icon">
            ...
            <div class="stat-card neutral">
              <div class="stat-info">
                ...
                <h3 class="stat-value">{{ trendData.neutral_count }}</h3>
                <div class="stat-ratio">{{ trendData.neutral_ratio }}%</div>
              </div>
              <div class="stat-icon">
...
const handleAnalyze = async () => {
  ...
  try {
    const response = await fetch('http://localhost:5000/api/sentiment-trend', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
...
const handleReset = () => {
  ...
  selectedModel.value = 'random_forest'
  showDropdown.value = false
  if (chartInstance) {
